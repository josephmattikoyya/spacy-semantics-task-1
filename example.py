...
answer_to_the_differences_between_using_sm_and_md = """
When using sm we were given the warning below evey time we ran the code.
there were also sentences being marked as less similar when using sm than with md
"""
